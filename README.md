...
<img src="assets/images/amiresponsive-screenshot.png" width=600 height=400>
...
The form section of the 'Contact Us' section works. Seea screenshot from the Code Institute Formdump page, below.
...
I tested the performance of the website on Google Lighthouse, on Dev-tools. Below is my site's score.
...
* All fonts, along with their variations and stylings on this site, were priorly tested on [Google Fonts](https://fonts.google.com/).